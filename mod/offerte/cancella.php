...
if(isset($_POST['submit'])&&($_POST['submit']=='SI')){
	...
	if(($chk_1==0)&&($chk_2==0)){
		...
		$db->delete('offerte',$_GET['id']);
		header("location:$root/index.php?azione=p_offerte&err=3");
		exit;
	
	}else{
		header("location:$root/index.php?azione=p_offertes&err=4");
		exit;	
	...
	header("location:$root/index.php?azione=p_offerte");
	exit;
