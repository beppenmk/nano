...
class Table
{
	...
	function __construct ($data ,$class_tr='',$type = null)
	{
		
		//beppe
		$this->class_tr = ($class_tr!='')?'class="'.$class_tr.'"':'';
		//beppe
		switch ($type)
		{
		case 'json-file':
		...
		default:
			...
			{
			//non mi interessa l'eccezzione array vuoto
	...
	echo $this->padding ()."<tbody>\n";
		...
		{
		echo $this->padding (2)."<tr ".$this->class_tr." >\n";
