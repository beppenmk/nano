...
/* Form Elements **********************************************************************************
   ...
   function startForm($action=false,$class='',$target='',$method='post') {
      ...
      $this->output .= '<form role="form"' . $class . $action . $method . $target . ' enctype="multipart/form-data">' . ((!$this->singleline)?("\n"):('')) . (($this->outputxhtml)?('<div>' . ((!$this->singleline)?("\n"):(''))):(''));
      $this->formopen = true;
...
//beppe toglie il chk per il campo hidden, lo voglio vuoto
  // if(!$name || !$value) {
...
/* Text Type Inputs *******************************************************************************
   ...
   function textInput($name=false,$label=false,$class=false,$lclass=false,$title=false,$maxsize=false,$size=false,$readonly=false,$value=false,$type=false,$required=false ,$placeholder=false) {
 	...
 	if(!$placeholder) { $placeholder = ''; }
      ...
      // generate output
      $this->output .= $label . '<input' . $type . $nametag . $class . $title . $size . $maxsize . $readonly . $value . $required . $placeholder. '/>' . (($this->newline)?("<br />"):('')) . ((!$this->singleline)?("\n"):(''));
